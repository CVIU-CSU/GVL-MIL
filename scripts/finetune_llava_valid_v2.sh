...
readonly NUM_TRY="freeze_backbone_valid"
...
train_model() {
    ...
    deepspeed --include="localhost:1" --master_port=29500 \
        ...
        --version ${PROMPT_VER} \
        --data_path ${DATA_BASE}/datasets/v2/descriptions/nfd_train.json \
...
run_evaluation() {
    ...
    CUDA_VISIBLE_DEVICES=0 python ${PROJECT_BASE}/llava/eval/model_vqa.py \
        ...
        --question-file ${DATA_BASE}/datasets/v2/descriptions/nfd_valid.json \
