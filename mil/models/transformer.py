...
class Transformer(MIL):
    def __init__(self,
        ...
        make_trans_layer = lambda: TransLayer(
            ...
            dropout=dropout, mlp_dim=encoder_mlp_dim)
    ...
    def forward(self, h: torch.Tensor, loss_fn: nn.Module=None,
        ...
        """
        wsi_feats, log_dict = self.forward_features(h, attn_mask=attn_mask, return_attention=return_attention)  # log dict contains attention
