...
def _resolve_pretrained_source(pretrained_cfg: Dict[str, Any]) -> Tuple[str, Any]:
    ...
    # print("[_resolve_pretrained_source] pretrained_file?", pretrained_file)
    # print(pretrained_file and os.path.exists(pretrained_file))
...
def _find_pretrained_source(hf_path, local_folder):
    ...
    print("[_find_pretrained_source] weights_path?", os.path.exists(weights_path))
    print(weights_path)
...
def load_pretrained(
    ...
    # print("[load_pretrained]", pretrained_cfg['local_path_parent'])
    # print("[load_pretrained] load_from", load_from)
    # change for nfi
...
def build_model_with_cfg(
    ...
    """
    # print("[build_model_with_cfg] from_pretrained =", from_pretrained)
    # print("[build_model_with_cfg] pretrained =", pretrained)
    if model_cfg is None:
        model = model_cls(**kwargs)
    else:
        model = model_cls(config=model_cfg, **kwargs)
    model.pretrained_cfg = pretrained_cfg
    # print("[build_model_with_cfg] pretrained_cfg", pretrained_cfg)
    if pretrained:
